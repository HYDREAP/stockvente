...
public class ClientDAO {
    ...
    public void rechercheClientParNom( String nom ) throws Exception {
        ...
        try {
            ...
            java.util.List result = session.createQuery( " from Client client where client.nomClient = '" + nom + "' " )
                    .list();
    ...
    public void listeClient() throws Exception {
        ...
        try {
            ...
            java.util.List result = session.createQuery( " from Client " ).list();
